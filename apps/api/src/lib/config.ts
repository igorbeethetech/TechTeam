...
export const config = {
  ...
  BETTER_AUTH_URL: optionalEnv("BETTER_AUTH_URL", "http://localhost:3010"),
  WEB_URL: optionalEnv("WEB_URL", "http://localhost:3009"),
  API_PORT: Number(optionalEnv("API_PORT", "3010")),
